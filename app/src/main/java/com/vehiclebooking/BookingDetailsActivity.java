...
public class BookingDetailsActivity extends AppCompatActivity {
    ...
    private void populateUI() {
        ...
        // Format travel date
        SimpleDateFormat travelDateFormat = new SimpleDateFormat("dd MMMM yyyy", Locale.getDefault());
        String formattedTravelDate = travelDateFormat.format(booking.getTravelDate());
        travelDateDetails.setText(formattedTravelDate);
        
        // Format booking time
        SimpleDateFormat bookingTimeFormat = new SimpleDateFormat("dd MMMM yyyy, hh:mm a", Locale.getDefault());
        String formattedBookingTime = bookingTimeFormat.format(new Date(booking.getTimestamp()));
    ...
    private String createDetailedBookingSummary() {
        ...
        summary.append("Booked On: ").append(dateFormat.format(new Date(booking.getTimestamp()))).append("\n\n");
        ...
        summary.append("Export Date: ").append(dateFormat.format(new Date()));
